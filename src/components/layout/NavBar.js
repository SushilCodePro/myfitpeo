...
function NavBar() {
    return (
        <div className="bg-gray-700 h-auto flex items-center flex-col sm:flex-row space-y-1 sm:space-y-0">
            <div className='w-full sm:flex-1 flex items-center  ml-1'>
                <div className='icon'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 text-blue-500 ml">
            ...
            <div className="w-full flex sm:flex-1 sm:justify-end justify-evenly space-x-6 p-2">
                <div className=''>
